...
func main() {
	args := os.Args[1:]
	if len(args) < 2 {
		fmt.Println("Usage: encrypt [encryption key] [filepath globs...]")
		os.Exit(0)
	}
...
func encryptFile(filename string, lt *s3proxy.LookupTable) bool {
	fmt.Printf("Encrypting file %q ... ", filename)
